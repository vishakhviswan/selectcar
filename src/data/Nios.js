export default [{
  era: [
    ...
    {
      subheading: "Interior",
      features: ["Premium dual tone beige & black interior colour",
    ...
    {
      subheading: "Audio",
      features: ["17.64cm(7inch) Touch screen audio video system with smart phone navigation",
...

    {
      ...
      features: ["Motor driven (electic) power steering",
